...
HOST_GCC_FINAL_CFLAGS = $(HOST_GCC_COMMON_CFLAGS)
HOST_GCC_FINAL_CXXFLAGS = $(HOST_GCC_COMMON_CXXFLAGS)
HOST_GCC_FINAL_LDFLAGS = $(HOST_GCC_COMMON_LDFLAGS)
...
define  HOST_GCC_FINAL_CONFIGURE_CMDS
	(cd $(HOST_GCC_FINAL_SRCDIR) && rm -rf config.cache; \
		$(HOST_CONFIGURE_OPTS) \
		CFLAGS="$(HOST_GCC_FINAL_CFLAGS)" \
		CXXFLAGS="$(HOST_GCC_FINAL_CXXFLAGS)" \
		LDFLAGS="$(HOST_GCC_FINAL_LDFLAGS)" \
